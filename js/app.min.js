(() => {
    ...
    new Swiper(".main-slider", {
    ...
    }), new Swiper(".product-slider-wrap", {
        observeParents: !0,
        slidesPerView: 1,
        spaceBetween: 0,
        speed: 400,
        ...
        // loop: !0,
        navigation: {
            prevEl: ".product-catalog__control-l",
            nextEl: ".product-catalog__control-r"
        },
        pagination: {
    ...
    let Slider1 = new Swiper(".body-services__slider", {
        // autoplay: {
        //     delay: 3000,
        //     disableOnInteraction: !1
        // },
        ...
        loop: !0,
        navigation: {
            nextEl: ".serv-icon-right-chevron",
            prevEl: ".serv-icon-left-chevron"
        },
        thumbs: {
            swiper: {
                // loop: !0,
    ...
    let Slider2 = new Swiper(".bottom-content", {
        // autoplay: {
        //     delay: 3000,
        //     disableOnInteraction: !1
        // },
    ...
    // let Slider3 = new Swiper(".desription-services", {
    //     // autoplay: {
    //     //     delay: 3000,
    //     //     disableOnInteraction: !1
    //     // },
    ...
    // Slider2.controller.control = Slider3;
    ...
    u && u.addEventListener("click", (function (e) {
        ...
        e.preventDefault(), document.querySelector(".question").classList.add("toping")
    ...
    m && m.addEventListener("click", (function (e) {
        ...
        e.preventDefault(), document.querySelector(".question").classList.remove("toping")
...
let phone2 = document.querySelector('.user-form__input-phone');
let phone3 = document.querySelector('.user-form__input-phone2');
let phone4 = document.querySelector('.user-form__input-phone3');
if (phone) {
...
if (phone2) {
    phone2.addEventListener('blur', function () {
        document.querySelector('.form__registration-inp-phone').classList.add('focus')
    })
}
if (phone3) {
    phone3.addEventListener('blur', function () {
        document.querySelector('.form__registration-inp-phone2').classList.add('focus')
    })
}
if (phone4) {
    phone4.addEventListener('blur', function () {
        document.querySelector('.form__registration-inp-phone3').classList.add('focus')
    })
}
...
const productsLink = document.querySelectorAll('.product__image');
...
// SERVICES_POPUP_START
// let servicesBtns = document.querySelectorAll('.bottom-content__btn');
// let servicesName = document.getElementById('services-name');

// if (servicesBtns) {
//     for (let index = 0; index < servicesBtns.length; index++) {
//         const servicesBtn = servicesBtns[index];
//         servicesBtn.addEventListener('click', function () {
//             servicesName.innerText = servicesBtn.parentNode.children[0].innerText;
//         })
//     }
// }
// SERVICES_POPUP_END
...
let langChanges = document.querySelectorAll('.lang__change');
let langPopup = document.querySelector('.lang__popup');
let langTelephone = 'RU';
// console.log('RU');

document.addEventListener('click', function (e) {
    if (!e.target.closest('.lang__popup')) {
...
for (let index = 0; index < langChanges.length; index++) {
    const langChange = langChanges[index];
    langChange.addEventListener('click', function () {
        let tempLang = langCurrent.innerText;
        langCurrent.innerText = langChange.innerText;
        langChange.innerText = tempLang;
        langTelephone = langCurrent.innerText;
        // console.log(langTelephone);
        validRegistration();
        langPopup.classList.remove('active');
        ...
        if (inputs) {
            for (let index = 0; index < inputs.length; index++) {
                ...
                if (langTelephone === 'RU') {
                    ...
                    masked = "+9999999999999999"
                }
            let im = new Inputmask(masked, { autoUnmask: true });
...
function validRegistration() {
    let email = document.querySelector('.user-form__input-email');
    let name = document.querySelector('.user-form__input-name');
    let phone = document.querySelector('.user-form__input-phone');
    let registrationBtn = document.querySelector('.form-order__btn');
...
function validQuestion() {
    let emailQ = document.querySelector('.user-form__input-email2');
    let nameQ = document.querySelector('.user-form__input-name2');
    let phoneQ = document.querySelector('.user-form__input-phone2');
    let textareaQ = document.querySelector('.user-form__input-question');
    let formQuestionBtn = document.querySelector('.form-question__btn');
    

    function validateEmail(emailQ) {
        const EMAIL_REGEXP = /^(([^<>()[\].,;:\s@"]+(\.[^<>()[\].,;:\s@"]+)*)|(".+"))@(([^<>()[\].,;:\s@"]+\.)+[^<>()[\].,;:\s@"]{2,})$/iu;
        return EMAIL_REGEXP.test(emailQ.value);
    }

    if (emailQ.value != 0 
        && validateEmail(emailQ) 
        && nameQ.value !=0 
        && phoneQ.value.length === 10
        && textareaQ.value !=0) {
        formQuestionBtn.classList.remove('disabled');
        formQuestionBtn.setAttribute('type', 'submit')
        formQuestionBtn.removeAttribute('disabled')
    } else {
        formQuestionBtn.classList.add('disabled');
        formQuestionBtn.setAttribute('type', '')
        formQuestionBtn.setAttribute('disabled', 'disabled')
    }
}
function validQuestionServises() {
    let emailS = document.querySelector('.user-form__input-email3');
    let nameS = document.querySelector('.user-form__input-name3');
    let phoneS = document.querySelector('.user-form__input-phone3');
    let formServicesBtn = document.querySelector('.form-services__btn');
    

    function validateEmail(emailS) {
        const EMAIL_REGEXP = /^(([^<>()[\].,;:\s@"]+(\.[^<>()[\].,;:\s@"]+)*)|(".+"))@(([^<>()[\].,;:\s@"]+\.)+[^<>()[\].,;:\s@"]{2,})$/iu;
        return EMAIL_REGEXP.test(emailS.value);
    }

    if (emailS.value != 0 
        && validateEmail(emailS) 
        && nameS.value !=0 
        && phoneS.value.length === 10) {
        formServicesBtn.classList.remove('disabled');
        formServicesBtn.setAttribute('type', 'submit')
        formServicesBtn.removeAttribute('disabled')
    } else {
        formServicesBtn.classList.add('disabled');
        formServicesBtn.setAttribute('type', '')
        formServicesBtn.setAttribute('disabled', 'disabled')
    }
}
...
// QUESTION_WINDOW_START
let question = document.querySelector('.question .question-icon');
let questionHidden = document.querySelector('.question__hidden');
let questionHiddenInsite = document.querySelector('.question__hidden-insite');
let questionLinks = document.querySelectorAll('.question__hidden .social__link');

if (question) {
    document.addEventListener('click', function (e) {
        if (!e.target.closest('.question .question-icon')) {
            questionHidden.classList.remove('active');
            questionHiddenInsite.classList.remove('active');
        }
    })
    question.addEventListener('click', function (e) {
        questionHidden.classList.add('active');
        questionHiddenInsite.classList.add('active');
    })
    for (let index = 0; index < questionLinks.length; index++) {
        const questionLink = questionLinks[index];
...
// fsLightbox__start
if (document.querySelector('.gallery') || document.querySelector('.product-wrap')) {
    fsLightbox.props.type = 'image';
    fsLightbox.props.types = [null, null, null];
}
// fsLightbox__end
...
// CATALOG_START
const catalogItems= document.querySelectorAll('.data a');
